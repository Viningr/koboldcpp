...
R"(__kernel void kernel_gemv_moe_q4_k_f32_ns_wimg(
)"
...
R"(        regQ.s0 = read_imageui(src0_q, (int)(q_base)).x;
)"
R"(        regQ.s1 = read_imageui(src0_q, (int)(q_base + ne01)).x;
)"
R"(        regQ.s2 = read_imageui(src0_q, (int)(q_base + ne01 * 2)).x;
)"
R"(        regQ.s3 = read_imageui(src0_q, (int)(q_base + ne01 * 3)).x;
)"
R"(
)"
R"(        uint y_offset = i11 * ne00 / 4 + ib * 8;
